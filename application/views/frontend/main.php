    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">ShopList</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <input type="text" id="txtSearch" class="form-control no-curve ui-autocomplete-input" style="background-color:#fff;" placeholder="e.g. Drypers" autocomplete="off">
                    <div class="intro-text">
                        <span class="name">ShopList</span>
                        <hr class="star-light">
                        <span class="skills">We All Love Promotions !</span>
                    </div>
                </div>
            </div>
        </div>
